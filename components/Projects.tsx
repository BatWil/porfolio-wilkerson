...
const projects = [
  ...
  { id: 2, category: "web", title: "Portafolio Web", description: "Un sitio web de portafolio responsivo construido con Next.js para mostrar proyectos y habilidades.", technologies: ["Next.js", "Tailwind CSS", "Vercel", "React"], icon: <Globe size={32} />, githubUrl: "https://github.com/BatWil/porfolio-wilkerson", liveUrl: "https://proyecto3.com" },
  { id: 3, category: "web", title: "Control de Inventario y Venta", description: "Una aplicación web para gestionar el inventario y las ventas de productos en una tienda de ropa. Con actualización en tiempo real", technologies: ["Next.js", "Node.js", "PostgreSQL", "XML", "JSON", "Tailwind CSS"], icon: <Database size={32} />, githubUrl: "https://github.com/usuario/proyecto4", liveUrl: "https://proyecto4.com" },
  { id: 4, category: "mobile", title: "Aplicación de ToDo", description: "Aplicación móvil para agendar recordatorios y gestionar tareas diarias de manera eficiente.", technologies: ["React Native", "Ionic", "PostgreSQL", "TypeScript", "CSS"], icon: <Smartphone size={32} />, githubUrl: "https://github.com/BatWil/todo", liveUrl: "https://proyecto5.com" },
  { id: 5, category: "mobile", title: "Generador de Versículos Bíblicos", description: "Una app móvil que genera versículos bíblicos aleatorios, consumiendo datos de una API.", technologies: ["React Native", "Ionic", "API REST"], icon: <Smartphone size={32} />, githubUrl: "https://github.com/BatWil/biblica", liveUrl: "https://proyecto6.com" },
]
